...
async def startCMD(client: FilterBot, message: Message):
    ...
    keyboard = [[
      ...
      InlineKeyboardButton('Update', url='t.me/AM_FILMS'),
      InlineKeyboardButton('Support', url='https://t.me/+sSWbe8vjU2s1ZTRl')
      ]]
...
async def aboutCMD(client: FilterBot, message: Message):
    ...
    keyboard = [[ InlineKeyboardButton('Tutorial', url='https://t.me/+sSWbe8vjU2s1ZTRl'),
                   InlineKeyboardButton('Repo', url='https://t.me/AM_FILMS) ],
